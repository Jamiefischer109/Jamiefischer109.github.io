...
This is a bar chart created using Chartbuilder showing the top 10 states with the highest minimum wage in 2021. Minimum wage is a very pressing issue in today's society, and I was interested in learning about the various wage standards across the country. I Googled "2021 minimum wage by state," and sifted through various sources to find a comprehensive data set. Though the set included the minimum wage of all 50 states, I decided it would easiest to digest if I focused on the top 10. Original data can be accessed [here](https://www.opploans.com/oppu/articles/states-with-highest-minimum-wages/).
